...
#define __KDQ_IMPL( type, SCOPE )                                                                                      \
    ...
    {                                                                                                                  \
        ...
        if( new_bits == q->bits )                                                                                      \
            return q->bits; /* unchanged */                                                                            \
        if( new_bits > q->bits )                                                                                       \
            q->a = (type*)krealloc( q->km, q->a, ( 1ULL << new_bits ) * sizeof( type ) );                              \
        ...
        { /* wrapped */                                                                                                \
            memmove( q->a + ( new_size - ( old_size - q->front ) ), q->a + q->front,                                   \
                     ( old_size - q->front ) * sizeof( type ) );                                                       \
