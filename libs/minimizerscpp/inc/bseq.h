...
mm_bseq1_t* mm_bseq_read3( mm_bseq_file_t* fp, int chunk_size, int with_qual, int with_comment, int frag_mode,
                           int* n_ );
...
mm_bseq1_t* mm_bseq_read_frag2( int n_fp, mm_bseq_file_t** fp, int chunk_size, int with_qual, int with_comment,
                                int* n_ );
