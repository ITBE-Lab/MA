  ...
  public:
    ...
    class SoCInserter
    {
      ...
      public:
        ...
        {
            auto tuiReadIds = pDB->pPairedReadTable->insertRead( uiSequencerId, pReadA, pReadB );
            return std::make_pair( ReadContex( tuiReadIds.first, pDB->pSocTable ),
                                   ReadContex( tuiReadIds.second, pDB->pSocTable ) );
        } // method
