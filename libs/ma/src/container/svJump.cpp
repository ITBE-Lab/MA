...
void exportSVJump( py::module& rxPyModuleId )
{
    ...
    py::class_<SvJump>( rxPyModuleId, "SvJump" )
        .def( py::init<std::shared_ptr<Presetting>, const Seed&, const Seed&, const bool>( ) )
        .def( py::init<std::shared_ptr<Presetting>, const Seed&, nucSeqIndex, const bool>( ) )
    ...
    py::class_<SvCall>( rxPyModuleId, "SvCall" )
        ...
        .def_readwrite( "coverage", &SvCall::uiCoverage )
