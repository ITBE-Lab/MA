...
void exportIntervalTree( )
{
    ...
    // export the SegmentVector class
    boost::python::class_<SegmentVector, boost::python::bases<Container>,
                          std::shared_ptr<SegmentVector>>( "SegmentVector" )
        ...
        .def(
            boost::python::vector_indexing_suite<SegmentVector,
                                                 /*
    ...
    // tell boost python that pointers of these classes can be converted implicitly
    boost::python::implicitly_convertible<std::shared_ptr<SegmentVector>,
