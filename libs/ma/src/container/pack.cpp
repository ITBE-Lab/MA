...
class FastaReader : public FastaDescriptor
{
  public:
    ...
    void vLoadFastaFile( const char* pcFileName )
    {
        ...
        FastaStreamReader<std::ifstream> fastaReader( pcFileName, xMode );
...
void Pack::vAppendFASTA( const std::string& sFastaFilePath )
{
     ...
     */
    auto xMode = std::ios::in | std::ios::binary;
    FastaStreamReader<std::ifstream> xFastaReader( sFastaFilePath, xMode );
...
void exportPack( libMS::SubmoduleOrganizer& xOrganizer )
{
    py::class_<Pack, libMS::Container, std::shared_ptr<Pack>>( xOrganizer.container(), "Pack" )
        ...
        .def( "extract_forward_strand_n", &Pack::vColletionWithoutReverseStrandAsNucSeqWithN )
        ...
        .def( "amount_of_region_covered_by_hole", &Pack::amountOfRegionCoveredByHole )
        .def( "seq_id_for_pos", &Pack::uiSequenceIdForPosition )
        .def( "start_of_sequence", &Pack::startOfSequenceWithName )
        .def( "id_of_sequence", &Pack::uiSequenceIdForName )
        .def( "length_of_sequence", &Pack::lengthOfSequenceWithName )
        .def( "length_of_sequence_with_id", &Pack::lengthOfSequenceWithId )
        .def( "start_of_sequence_id", &Pack::startOfSequenceWithId )
        .def( "end_of_sequence_id", &Pack::endOfSequenceWithId )
        .def( "name_of_sequence", &Pack::nameOfSequenceForPosition )
        .def( "num_contigs", &Pack::uiNumContigs )
        .def( "name_of_sequence_id", &Pack::nameOfSequenceWithId )
