...
std::shared_ptr<Pledge> Module::promiseMe( std::shared_ptr<Module> pThis,
...
std::shared_ptr<Pledge> Pledge::makePledge( std::shared_ptr<Module> pledger,
...
void simGetBoost1( std::vector<std::shared_ptr<Pledge>> vPledges )
{
    Pledge::simultaneousGet( vPledges );
} // function

void simGetBoost2( std::vector<std::shared_ptr<Pledge>> vPledges, unsigned int uiThreads )
{
