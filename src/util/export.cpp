    ...
    )
{
    ...
    {
        //lock the query in for this subgraph
        std::shared_ptr<Pledge> pQueriesLocked = Module::promiseMe(
                pLockQueries, 
                std::vector<std::shared_ptr<Pledge>>
                {
                    pQueries
        ...
        std::shared_ptr<Pledge> pQuery1 = Module::promiseMe(
                pLock, 
                std::vector<std::shared_ptr<Pledge>>
                {
                    pQuery
        ...
        //the seeding stage
        std::shared_ptr<Pledge> pSeeds1 = Module::promiseMe(
                pSeeding, 
                std::vector<std::shared_ptr<Pledge>>
                {
                    pFMDIndex,
        ...
        //the coupling stage
        std::shared_ptr<Pledge> pCoupled1 = Module::promiseMe(
                pCouple, 
                std::vector<std::shared_ptr<Pledge>>
                {
                    pSOCs1, pQuery1
        ...
        // assign a mapping quality
        std::shared_ptr<Pledge> pAlignment1 = Module::promiseMe(
                    pMapping, 
                    std::vector<std::shared_ptr<Pledge>>
                    {
                        pQuery1,
        ...
        std::shared_ptr<Pledge> pAlignment2 = Module::promiseMe(
                    pMapping, 
                    std::vector<std::shared_ptr<Pledge>>
                    {
                        pQuery2,
