...
void exportContainer( )
{
    ...
    boost::python::class_<Container, std::shared_ptr<Container>>( "Container",
    ...
    boost::python::class_<ContainerVector, boost::python::bases<Container>,
                          std::shared_ptr<ContainerVector>>(
        "ContainerVector", boost::python::init<std::shared_ptr<Container>>( ) )
        .def(
            boost::python::vector_indexing_suite<ContainerVector,
                                                 /*
    ...
    // tell boost python that pointers of these classes can be converted implicitly
    boost::python::implicitly_convertible<std::shared_ptr<ContainerVector>,
