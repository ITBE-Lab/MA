...
#error                                                                                             \
    "No SIMD instruction set enabled. Check if SSE4.1 or AVX2 instructions are available and add `-msse4.1' or `-mavx2' to CFLAGS."
#endif
...
#define arch_cap( )                                                                                \
    ( {                                                                                            \
        ...
        ( ( sse4_cap != 0 ) ? ARCH_CAP_SSE41 : 0 ) |                                               \
            ( ( avx2_cap && bmi1_cap && lzcnt_cap ) ? ARCH_CAP_AVX2 : 0 );                         \
    } )
