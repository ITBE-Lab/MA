...
/**
 * @macro ZCNT_RESULT
 * @brief workaround for a bug in gcc (<= 5), all the results of tzcnt / lzcnt macros must be
 * modified by this label
 */
#ifndef ZCNT_RESULT
 ...
 */
/* store */
#define _store_sb( _scv, sv16 )                                                                    \
    {                                                                                              \
        _store_v32i8( ( _scv ).v1, _from_v16i8_v32i8( sv16 ) );                                    \
    }
...
#define _make_gap( _e1, _e2, _e3, _e4 )                                                            \
    ( ( v16i8_t ){_mm_set_epi8( ( _e4 ), ( _e4 ), ( _e4 ), ( _e4 ), ( _e3 ), ( _e3 ), ( _e3 ),     \
                                ( _e3 ), ( _e2 ), ( _e2 ), ( _e2 ), ( _e2 ), ( _e1 ), ( _e1 ),     \
                                ( _e1 ), ( _e1 ) )} )
...
#define _load_gap( _ptr, _idx )                                                                    \
    ( ( v32i8_t ){                                                                                 \
        _mm256_shuffle_epi32( _mm256_load_si256( ( __m256i const * )( _ptr ) ), ( _idx ) )} )
...
#define wr_128( _ptr, _e )                                                                         \
    {                                                                                              \
        _mm_store_si128( ( __m128i * )( _ptr ), ( _e ) );                                          \
    }
#define _ex_128( k, h ) ( _mm_extract_epi64( ( elem_128_t )k, h ) )
#define ex_128( k, p )                                                                             \
    ( ( ( ( ( p ) >> 3 ) ? _ex_128( k, 1 ) : _ex_128( k, 0 ) ) >> ( ( ( p )&0x07 ) << 3 ) ) &      \
      ( WCR_OCC_SIZE - 1 ) )
...
#define fence( ) ( { __asm__ volatile( "mfence" ); } )
#else /* > 4.7 */
#define cas( ptr, cmp, val )                                                                       \
