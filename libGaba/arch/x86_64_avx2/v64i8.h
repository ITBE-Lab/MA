...
#define _a_v64i8( intrin, expander, ... )                                                          \
    ( ( v64i8_t ){_i_v64i8( intrin )( expander##_v64i8_1( __VA_ARGS__ ) ),                         \
                  _i_v64i8( intrin )( expander##_v64i8_2( __VA_ARGS__ ) )} )
#define _a_v64i8x( intrin, expander, ... )                                                         \
    ( ( v64i8_t ){_i_v64i8x( intrin )( expander##_v64i8_1( __VA_ARGS__ ) ),                        \
...
#define _swap_v64i8( a )                                                                           \
    ( ( v64i8_t ){                                                                                 \
        _mm256_permute2x128_si256( _mm256_shuffle_epi8( ( a ).v2, _swap_idx_v64i8( ) ),            \
                                   _mm256_shuffle_epi8( ( a ).v2, _swap_idx_v64i8( ) ), 0x01 ),    \
        _mm256_permute2x128_si256( _mm256_shuffle_epi8( ( a ).v1, _swap_idx_v64i8( ) ),            \
                                   _mm256_shuffle_epi8( ( a ).v1, _swap_idx_v64i8( ) ), 0x01 )} )
...
#define _bsl_v64i8( a, imm )                                                                       \
    ( ( v64i8_t ){                                                                                 \
        _mm256_alignr_epi8( ( a ).v1, _mm256_permute2x128_si256( ( a ).v1, ( a ).v2, 0x08 ), 15 ), \
        _mm256_alignr_epi8( ( a ).v2, _mm256_permute2x128_si256( ( a ).v1, ( a ).v2, 0x21 ),       \
                            15 )} )
#define _bsr_v64i8( a, imm )                                                                       \
    ( ( v64i8_t ){                                                                                 \
        _mm256_alignr_epi8( _mm256_permute2x128_si256( ( a ).v1, ( a ).v2, 0x21 ), ( a ).v1, 1 ),  \
        _mm256_alignr_epi8( _mm256_castsi128_si256( _mm256_extracti128_si256( ( a ).v2, 1 ) ),     \
                            ( a ).v2, 1 )} )
#define _shl_v64i8( a, imm )                                                                       \
    ( ( v64i8_t ){_mm256_slli_epi32( ( a ).v1, ( imm ) ), _mm256_slli_epi32( ( a ).v2, ( imm ) )} )
#define _shr_v64i8( a, imm )                                                                       \
    ( ( v64i8_t ){_mm256_srli_epi32( ( a ).v1, ( imm ) ), _mm256_srli_epi32( ( a ).v2, ( imm ) )} )
#define _sal_v64i8( a, imm )                                                                       \
    ( ( v64i8_t ){_mm256_slai_epi32( ( a ).v1, ( imm ) ), _mm256_slai_epi32( ( a ).v2, ( imm ) )} )
...
#define _mask_v64i8( a )                                                                           \
    ( ( v64_mask_t ){.m1 = _i_v64i8( movemask )( ( a ).v1 ),                                       \
                     .m2 = _i_v64i8( movemask )( ( a ).v2 )} )

/* convert */
#define _cvt_v64i16_v64i8( a )                                                                     \
    ( ( v64i8_t ){_mm256_packs_epi16( _mm256_permute2x128_si256( ( a ).v1, ( a ).v2, 0x20 ),       \
                                      _mm256_permute2x128_si256( ( a ).v1, ( a ).v2, 0x31 ) ),     \
                  _mm256_packs_epi16( _mm256_permute2x128_si256( ( a ).v3, ( a ).v4, 0x20 ),       \
...
#define _print_v64i8( a )                                                                          \
    {                                                                                              \
        int8_t _tmp[ 64 ];                                                                         \
        v64i8_t _tmpv = ( a );                                                                     \
        _storeu_v64i8( _tmp, _tmpv );                                                              \
        debug(                                                                                     \
            "(v64i8_t) %s(%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, "        \
            "%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, "                     \
            "%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, "                     \
            "%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d)",                     \
            #a, _tmp[ 32 + 31 ], _tmp[ 32 + 30 ], _tmp[ 32 + 29 ], _tmp[ 32 + 28 ],                \
            _tmp[ 32 + 27 ], _tmp[ 32 + 26 ], _tmp[ 32 + 25 ], _tmp[ 32 + 24 ], _tmp[ 32 + 23 ],   \
            _tmp[ 32 + 22 ], _tmp[ 32 + 21 ], _tmp[ 32 + 20 ], _tmp[ 32 + 19 ], _tmp[ 32 + 18 ],   \
            _tmp[ 32 + 17 ], _tmp[ 32 + 16 ], _tmp[ 32 + 15 ], _tmp[ 32 + 14 ], _tmp[ 32 + 13 ],   \
            _tmp[ 32 + 12 ], _tmp[ 32 + 11 ], _tmp[ 32 + 10 ], _tmp[ 32 + 9 ], _tmp[ 32 + 8 ],     \
            _tmp[ 32 + 7 ], _tmp[ 32 + 6 ], _tmp[ 32 + 5 ], _tmp[ 32 + 4 ], _tmp[ 32 + 3 ],        \
            _tmp[ 32 + 2 ], _tmp[ 32 + 1 ], _tmp[ 32 + 0 ], _tmp[ 31 ], _tmp[ 30 ], _tmp[ 29 ],    \
            _tmp[ 28 ], _tmp[ 27 ], _tmp[ 26 ], _tmp[ 25 ], _tmp[ 24 ], _tmp[ 23 ], _tmp[ 22 ],    \
            _tmp[ 21 ], _tmp[ 20 ], _tmp[ 19 ], _tmp[ 18 ], _tmp[ 17 ], _tmp[ 16 ], _tmp[ 15 ],    \
            _tmp[ 14 ], _tmp[ 13 ], _tmp[ 12 ], _tmp[ 11 ], _tmp[ 10 ], _tmp[ 9 ], _tmp[ 8 ],      \
            _tmp[ 7 ], _tmp[ 6 ], _tmp[ 5 ], _tmp[ 4 ], _tmp[ 3 ], _tmp[ 2 ], _tmp[ 1 ],           \
            _tmp[ 0 ] );                                                                           \
    }
#else
