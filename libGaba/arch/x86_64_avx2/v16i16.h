...
#define _seta_v16i16( ... ) ( ( v16i16_t ){_mm256_set_epi16( __VA_ARGS__ )} )
...
#define _swap_v16i16( a )                                                                          \
    ( ( v16i16_t ){                                                                                \
        _mm256_permute2x128_si256( _mm256_shuffle_epi8( ( a ).v1, _swap_idx_v16i16( ) ),           \
                                   _mm256_shuffle_epi8( ( a ).v1, _swap_idx_v16i16( ) ), 0x01 )} )
...
#define _ext_v16i16( a, imm ) ( ( int16_t )_i_v16i16( extract )( ( a ).v1, ( imm ) ) )

/* mask */
#define _mask_v16i16( a )                                                                          \
    ( ( v16_mask_t ){                                                                              \
        .m1 = _mm256_movemask_epi8( _mm256_packs_epi16(                                            \
            ( a ).v1, _mm256_castsi128_si256( _mm256_extracti128_si256( ( a ).v1, 1 ) ) ) )} )

/* horizontal max (reduction max) */
#define _hmax_v16i16( a )                                                                          \
    ( {                                                                                            \
        __m128i _t = _mm_max_epi16( _mm256_castsi256_si128( ( a ).v1 ),                            \
...
/* convert */
#define _cvt_v16i8_v16i16( a ) ( ( v16i16_t ){_mm256_cvtepi8_epi16( ( a ).v1 )} )
