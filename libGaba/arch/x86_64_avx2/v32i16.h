...
#define _ins_v32i16( a, val, imm )                                                                 \
    {                                                                                              \
        ...
        {                                                                                          \
            ( a ).v2 = _i_v32i16( insert )( ( a ).v2, ( val ),                                     \
                                            ( imm ) - sizeof( __m256i ) / sizeof( int16_t ) );     \
        }                                                                                          \
    }
#define _ext_v32i16( a, imm )                                                                      \
    ( ( int16_t )( ( ( imm ) < sizeof( __m256i ) / sizeof( int16_t ) )                             \
                       ...
                       : _i_v32i16( extract )(                                                     \
                             ( a ).v2, ( imm ) - sizeof( __m256i ) / sizeof( int16_t ) ) ) )

/* mask */
#define _mask_v32i16( a )                                                                          \
    ( ( v32_mask_t ){.m1 = _mm256_movemask_epi8( _mm256_permute4x64_epi64(                         \
...
#define _cvt_v32i8_v32i16( a )                                                                     \
    ( ( v32i16_t ){_mm256_cvtepi8_epi16( _mm256_castsi256_si128( ( a ).v1 ) ),                     \
