...
#define _a_v32i8( intrin, expander, ... )                                                          \
    ( ( v32i8_t ){_i_v32i8( intrin )( expander##_v32i8_1( __VA_ARGS__ ) )} )
#define _a_v32i8x( intrin, expander, ... )                                                         \
    ( ( v32i8_t ){_i_v32i8x( intrin )( expander##_v32i8_1( __VA_ARGS__ ) )} )
...
#define _swap_v32i8( a )                                                                           \
    ( ( v32i8_t ){_mm256_permute2x128_si256( _mm256_shuffle_epi8( ( a ).v1, _swap_idx_v32i8( ) ),  \
...
#define _ext_v32i8( a, imm ) ( ( int8_t )_i_v32i8( extract )( ( a ).v1, ( imm ) ) )

/* shift */
#define _bsl_v32i8( a, imm )                                                                       \
    ( ( v32i8_t ){_mm256_alignr_epi8(                                                              \
        ( a ).v1, _mm256_permute2x128_si256( ( a ).v1, ( a ).v1, 0x08 ), 15 )} )
#define _bsr_v32i8( a, imm )                                                                       \
    ( ( v32i8_t ){_mm256_alignr_epi8(                                                              \
        _mm256_castsi128_si256( _mm256_extracti128_si256( ( a ).v1, 1 ) ), ( a ).v1, 1 )} )
#define _shl_v32i8( a, imm ) ( ( v32i8_t ){_mm256_slli_epi32( ( a ).v1, ( imm ) )} )
#define _shr_v32i8( a, imm ) ( ( v32i8_t ){_mm256_srli_epi32( ( a ).v1, ( imm ) )} )
#define _sal_v32i8( a, imm ) ( ( v32i8_t ){_mm256_slai_epi32( ( a ).v1, ( imm ) )} )
#define _sar_v32i8( a, imm ) ( ( v32i8_t ){_mm256_srai_epi32( ( a ).v1, ( imm ) )} )

/* mask */
#define _mask_v32i8( a ) ( ( v32_mask_t ){.m1 = _i_v32i8( movemask )( ( a ).v1 )} )

/* convert */
#define _cvt_v32i16_v32i8( a )                                                                     \
    ( ( v32i8_t ){_mm256_permute4x64_epi64( _mm256_packs_epi16( ( a ).v1, ( a ).v2 ), 0xd8 )} )
...
#define _print_v32i8( a )                                                                          \
    {                                                                                              \
        int8_t _tmp[ 32 ];                                                                         \
        v32i8_t _tmpv = ( a );                                                                     \
        _storeu_v32i8( _tmp, _tmpv );                                                              \
        debug(                                                                                     \
            "(v32i8_t) %s(%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, "        \
