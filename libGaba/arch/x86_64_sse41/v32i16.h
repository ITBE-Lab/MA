...
#define _a_v32i16( intrin, expander, ... )                                                         \
    ( ( v32i16_t ){_i_v32i16( intrin )( expander##_v32i16_1( __VA_ARGS__ ) ),                      \
...
#define _a_v32i16x( intrin, expander, ... )                                                        \
    ( ( v32i16_t ){_i_v32i16x( intrin )( expander##_v32i16_1( __VA_ARGS__ ) ),                     \
...
#define _ins_v32i16( a, val, imm )                                                                 \
    {                                                                                              \
        ...
        {                                                                                          \
            ( a ).v2 = _i_v32i8( insert )( ( a ).v2, ( val ),                                      \
                                           ( imm ) - sizeof( __m128i ) / sizeof( int16_t ) );      \
        }                                                                                          \
        else if ( ( imm ) < 3 * sizeof( __m128i ) / sizeof( int16_t ) )                            \
        {                                                                                          \
            ( a ).v3 = _i_v32i8( insert )( ( a ).v3, ( val ),                                      \
                                           ( imm )-2 * sizeof( __m128i ) / sizeof( int16_t ) );    \
        }                                                                                          \
        else                                                                                       \
        {                                                                                          \
            ( a ).v4 = _i_v32i8( insert )( ( a ).v4, ( val ),                                      \
...
#define _ext_v32i16( a, imm )                                                                      \
    ( ( int16_t )(                                                                                 \
        ( ( imm ) < sizeof( __m128i ) / sizeof( int16_t ) )                                        \
            ...
            : ( ( ( imm ) < 2 * sizeof( __m128i ) / sizeof( int16_t ) )                            \
                    ? _i_v32i16( extract )( ( a ).v2,                                              \
                                            ( imm ) - sizeof( __m128i ) / sizeof( int16_t ) )      \
                    : ( ( ( imm ) < 3 * sizeof( __m128i ) / sizeof( int16_t ) )                    \
                            ? _i_v32i16( extract )(                                                \
                                  ( a ).v3, ( imm )-2 * sizeof( __m128i ) / sizeof( int16_t ) )    \
                            : _i_v32i16( extract )( ( a ).v4, ( imm )-3 * sizeof( __m128i ) /      \
                                                                  sizeof( int16_t ) ) ) ) ) )

/* mask */
#define _mask_v32i16( a )                                                                          \
    ( ( v32_mask_t ){.m1 = _mm_movemask_epi8( _mm_packs_epi16( ( a ).v1, ( a ).v2 ) ),             \
                     .m2 = _mm_movemask_epi8( _mm_packs_epi16( ( a ).v3, ( a ).v4 ) )} )

/* horizontal max (reduction max) */
#define _hmax_v32i16( a )                                                                          \
    ( {                                                                                            \
        __m128i _vmax = _mm_max_epi16( _mm_max_epi16( ( a ).v1, ( a ).v2 ),                        \
...
#define _print_v32i16( a )                                                                         \
    {                                                                                              \
        int16_t _tmp[ 32 ];                                                                        \
        v32i16_t _tmpv = ( a );                                                                    \
        _storeu_v32i16( _tmp, _tmpv );                                                             \
        debug(                                                                                     \
            "(v32i16_t) %s(%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, "       \
            "%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d)",                     \
            #a, _tmp[ 31 ], _tmp[ 30 ], _tmp[ 29 ], _tmp[ 28 ], _tmp[ 27 ], _tmp[ 26 ],            \
            _tmp[ 25 ], _tmp[ 24 ], _tmp[ 23 ], _tmp[ 22 ], _tmp[ 21 ], _tmp[ 20 ], _tmp[ 19 ],    \
            _tmp[ 18 ], _tmp[ 17 ], _tmp[ 16 ], _tmp[ 15 ], _tmp[ 14 ], _tmp[ 13 ], _tmp[ 12 ],    \
            _tmp[ 11 ], _tmp[ 10 ], _tmp[ 9 ], _tmp[ 8 ], _tmp[ 7 ], _tmp[ 6 ], _tmp[ 5 ],         \
            _tmp[ 4 ], _tmp[ 3 ], _tmp[ 2 ], _tmp[ 1 ], _tmp[ 0 ] );                               \
    }
#else
