...
#define _a_v64i16( intrin, expander, ... )                                                         \
    ( ( v64i16_t ){_i_v64i16( intrin )( expander##_v64i16_1( __VA_ARGS__ ) ),                      \
...
#define _a_v64i16x( intrin, expander, ... )                                                        \
    ( ( v64i16_t ){_i_v64i16x( intrin )( expander##_v64i16_1( __VA_ARGS__ ) ),                     \
                  ...
                  : ( ( imm ) < 3 * _V64I16_N )                                                    \
                        ...
                        : ( ( imm ) < 4 * _V64I16_N )                                              \
                              ...
                              : ( ( imm ) < 5 * _V64I16_N )                                        \
                                    ...
                                    : ( ( imm ) < 6 * _V64I16_N )                                  \
                                          ? ( _i_v64i16( extract )( ( a ).v6,                      \
                                                                    ( imm )-5 * _V64I16_N ) )      \
                                          : ( ( imm ) < 7 * _V64I16_N )                            \
                                                ? ( _i_v64i16( extract )(                          \
                                                      ( a ).v7, ( imm )-6 * _V64I16_N ) )          \
                                                : ( _i_v64i16( extract )(                          \
                                                      ( a ).v8, ( imm )-7 * _V64I16_N ) ) ) )

/* mask */
#define _mask_v64i16( a )                                                                          \
    ( ( v64_mask_t ){.m1 = _mm_movemask_epi8( _mm_packs_epi16( ( a ).v1, ( a ).v2 ) ),             \
...
#define _hmax_v64i16( a )                                                                          \
    ( {                                                                                            \
        __m128i _vmax = _mm_max_epi16( _mm_max_epi16( _mm_max_epi16( ( a ).v1, ( a ).v2 ),         \
                                                      _mm_max_epi16( ( a ).v3, ( a ).v4 ) ),       \
                                       _mm_max_epi16( _mm_max_epi16( ( a ).v5, ( a ).v6 ),         \
                                                      _mm_max_epi16( ( a ).v7, ( a ).v8 ) ) );     \
        _vmax = _mm_max_epi16( _vmax, _mm_srli_si128( _vmax, 8 ) );                                \
        _vmax = _mm_max_epi16( _vmax, _mm_srli_si128( _vmax, 4 ) );                                \
        _vmax = _mm_max_epi16( _vmax, _mm_srli_si128( _vmax, 2 ) );                                \
        ( int16_t ) _mm_extract_epi16( _vmax, 0 );                                                 \
    } )

#define _cvt_v64i8_v64i16( a )                                                                     \
    ( ( v64i16_t ){                                                                                \
        _mm_cvtepi8_epi16( ( a ).v1 ), _mm_cvtepi8_epi16( _mm_srli_si128( ( a ).v1, 8 ) ),         \
        _mm_cvtepi8_epi16( ( a ).v2 ), _mm_cvtepi8_epi16( _mm_srli_si128( ( a ).v2, 8 ) ),         \
        _mm_cvtepi8_epi16( ( a ).v3 ), _mm_cvtepi8_epi16( _mm_srli_si128( ( a ).v3, 8 ) ),         \
        _mm_cvtepi8_epi16( ( a ).v4 ), _mm_cvtepi8_epi16( _mm_srli_si128( ( a ).v4, 8 ) )} )
...
#define _print_v64i16( a )                                                                         \
    {                                                                                              \
        int16_t _tmp[ 64 ];                                                                        \
        v64i16_t _tmpv = ( a );                                                                    \
        _storeu_v64i16( _tmp, _tmpv );                                                             \
        debug(                                                                                     \
            "(v64i16_t) %s(%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, "       \
            "%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, ",                    \
            "%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, ",                    \
            "%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d)", #a,                 \
            _tmp[ 32 + 31 ], _tmp[ 32 + 30 ], _tmp[ 32 + 29 ], _tmp[ 32 + 28 ], _tmp[ 32 + 27 ],   \
            _tmp[ 32 + 26 ], _tmp[ 32 + 25 ], _tmp[ 32 + 24 ], _tmp[ 32 + 23 ], _tmp[ 32 + 22 ],   \
            _tmp[ 32 + 21 ], _tmp[ 32 + 20 ], _tmp[ 32 + 19 ], _tmp[ 32 + 18 ], _tmp[ 32 + 17 ],   \
            _tmp[ 32 + 16 ], _tmp[ 32 + 15 ], _tmp[ 32 + 14 ], _tmp[ 32 + 13 ], _tmp[ 32 + 12 ],   \
            _tmp[ 32 + 11 ], _tmp[ 32 + 10 ], _tmp[ 32 + 9 ], _tmp[ 32 + 8 ], _tmp[ 32 + 7 ],      \
            _tmp[ 32 + 6 ], _tmp[ 32 + 5 ], _tmp[ 32 + 4 ], _tmp[ 32 + 3 ], _tmp[ 32 + 2 ],        \
            _tmp[ 32 + 1 ], _tmp[ 32 + 0 ], _tmp[ 31 ], _tmp[ 30 ], _tmp[ 29 ], _tmp[ 28 ],        \
            _tmp[ 27 ], _tmp[ 26 ], _tmp[ 25 ], _tmp[ 24 ], _tmp[ 23 ], _tmp[ 22 ], _tmp[ 21 ],    \
            _tmp[ 20 ], _tmp[ 19 ], _tmp[ 18 ], _tmp[ 17 ], _tmp[ 16 ], _tmp[ 15 ], _tmp[ 14 ],    \
            _tmp[ 13 ], _tmp[ 12 ], _tmp[ 11 ], _tmp[ 10 ], _tmp[ 9 ], _tmp[ 8 ], _tmp[ 7 ],       \
            _tmp[ 6 ], _tmp[ 5 ], _tmp[ 4 ], _tmp[ 3 ], _tmp[ 2 ], _tmp[ 1 ], _tmp[ 0 ] );         \
    }
#else
