...
#define _a_v16i16( intrin, expander, ... )                                                         \
    ( ( v16i16_t ){_i_v16i16( intrin )( expander##_v16i16_1( __VA_ARGS__ ) ),                      \
                   _i_v16i16( intrin )( expander##_v16i16_2( __VA_ARGS__ ) )} )
#define _a_v16i16x( intrin, expander, ... )                                                        \
    ( ( v16i16_t ){_i_v16i16x( intrin )( expander##_v16i16_1( __VA_ARGS__ ) ),                     \
...
#define _seta_v16i16( ... ) ( ( v16i16_t ){_mm_set_epi16( __VA_ARGS__ )} )

/* swap (reverse) */
#define _swap_idx_v16i16( ) ( _mm_set_epi8( 1, 0, 3, 2, 5, 4, 7, 6, 9, 8, 11, 10, 13, 12, 15, 14 ) )
#define _swap_v16i16( a )                                                                          \
    ( ( v16i16_t ){_mm_shuffle_epi8( ( a ).v2, _swap_idx_v16i16( ) ),                              \
...
#define _ins_v16i16( a, val, imm )                                                                 \
    {                                                                                              \
        ...
        {                                                                                          \
            ( a ).v2 = _i_v16i16( insert )( ( a ).v2, ( val ),                                     \
...
#define _ext_v16i16( a, imm )                                                                      \
    ( ( int16_t )( ( ( imm ) < sizeof( __m128i ) / sizeof( int16_t ) )                             \
                       ...
                       : _i_v16i16( extract )(                                                     \
                             ( a ).v2, ( imm ) - sizeof( __m128i ) / sizeof( int16_t ) ) ) )

/* mask */
#define _mask_v16i16( a )                                                                          \
    ( ( v16_mask_t ){.m1 = _mm_movemask_epi8( _mm_packs_epi16( ( a ).v1, ( a ).v2 ) )} )
...
#define _cvt_v16i8_v16i16( a )                                                                     \
    ( ( v16i16_t ){_mm_cvtepi8_epi16( ( a ).v1 ),                                                  \
...
#define _print_v16i16( a )                                                                         \
    {                                                                                              \
        int16_t _tmp[ 16 ];                                                                        \
        v16i16_t _tmpv = ( a );                                                                    \
        _storeu_v16i16( _tmp, _tmpv );                                                             \
        debug( "(v16i16_t) %s(%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d)",    \
               #a, _tmp[ 15 ], _tmp[ 14 ], _tmp[ 13 ], _tmp[ 12 ], _tmp[ 11 ], _tmp[ 10 ],         \
               _tmp[ 9 ], _tmp[ 8 ], _tmp[ 7 ], _tmp[ 6 ], _tmp[ 5 ], _tmp[ 4 ], _tmp[ 3 ],        \
               _tmp[ 2 ], _tmp[ 1 ], _tmp[ 0 ] );                                                  \
    }
#else
