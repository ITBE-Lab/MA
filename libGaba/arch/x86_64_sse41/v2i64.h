...
#define _a_v2i64( intrin, expander, ... )                                                          \
    ( ( v2i64_t ){_i_v2i64( intrin )( expander##_v2i64_1( __VA_ARGS__ ) )} )
#define _a_v2i64x( intrin, expander, ... )                                                         \
    ( ( v2i64_t ){_i_v2i64x( intrin )( expander##_v2i64_1( __VA_ARGS__ ) )} )
...
#define _swap_v2i64( x ) ( ( v2i64_t ){_mm_shuffle_epi32( ( x ).v1, 0x4e )} )
...
/* blend */
#define _sel_v2i64( mask, a, b ) ( ( v2i64_t ){_mm_blendv_epi8( ( b ).v1, ( a ).v1, ( mask ).v1 )} )
...
#define _ext_v2i64( a, imm ) ( ( int64_t )_i_v2i64( extract )( ( a ).v1, ( imm ) ) )

/* shift */
#define _shlv_v2i64( a, n ) ( ( v2i64_t ){_i_v2i64( sll )( ( a ).v1, ( n ).v1 )} )
#define _shrv_v2i64( a, n ) ( ( v2i64_t ){_i_v2i64( srl )( ( a ).v1, ( n ).v1 )} )

/* mask */
#define _mask_v2i64( a ) ( ( uint32_t )( _mm_movemask_epi8( ( a ).v1 ) ) )
...
/* convert */
#define _cvt_v2i32_v2i64( a ) ( ( v2i64_t ){_mm_cvtepi32_epi64( ( a ).v1 )} )

/* transpose */
#define _lo_v2i64( a, b ) ( ( v2i64_t ){_mm_unpacklo_epi64( ( a ).v1, ( b ).v1 )} )
#define _hi_v2i64( a, b ) ( ( v2i64_t ){_mm_unpackhi_epi64( ( a ).v1, ( b ).v1 )} )
