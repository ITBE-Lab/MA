...
#define _a_v2i32( intrin, expander, ... )                                                          \
    ( ( v2i32_t ){_i_v2i32( intrin )( expander##_v2i32_1( __VA_ARGS__ ) )} )
#define _a_v2i32e( intrin, expander, ... )                                                         \
    ( ( v2i32_t ){_i_v2i32e( intrin )( expander##_v2i32_1( __VA_ARGS__ ) )} )
#define _a_v2i32ev( intrin, expander, ... )                                                        \
    {                                                                                              \
        _i_v2i32e( intrin )( expander##_v2i32_1( __VA_ARGS__ ) );                                  \
    }
#define _a_v2i32x( intrin, expander, ... )                                                         \
    ( ( v2i32_t ){_i_v2i32x( intrin )( expander##_v2i32_1( __VA_ARGS__ ) )} )
...
#define _seta_v2i32( x, y )                                                                        \
    ( ( v2i32_t ){_mm_cvtsi64_si128( ( ( ( uint64_t )( x ) ) << 32 ) | ( ( uint32_t )( y ) ) )} )
#define _swap_v2i32( x ) ( ( v2i32_t ){_mm_shuffle_epi32( ( x ).v1, 0xe1 )} )
...
/* blend: (mask & b) | (~mask & a) */
#define _sel_v2i32( mask, a, b ) ( ( v2i32_t ){_mm_blendv_epi8( ( b ).v1, ( a ).v1, ( mask ).v1 )} )
...
#define _ext_v2i32( a, imm ) ( ( int32_t )_i_v2i32( extract )( ( a ).v1, ( imm ) ) )

/* shift */
#define _sal_v2i32( a, imm ) ( ( v2i32_t ){_i_v2i32( slli )( ( a ).v1, ( imm ) )} )
#define _sar_v2i32( a, imm ) ( ( v2i32_t ){_i_v2i32( srai )( ( a ).v1, ( imm ) )} )

/* mask */
#define _mask_v2i32( a ) ( ( uint32_t )( 0xff & _mm_movemask_epi8( ( a ).v1 ) ) )
...
#define _cvt_v2i8_v2i32( a ) ( ( v2i32_t ){_mm_cvtepi8_epi32( _mm_cvtsi64_si128( a ) )} )
#define _cvt_v2i32_v2i8( a )                                                                       \
    ( ( uint16_t )_mm_cvtsi128_si64( _mm_shuffle_epi8( ( a ).v1, _mm_cvtsi64_si128( 0x0400 ) ) ) )
#define _cvt_u64_v2i32( a ) ( ( v2i32_t ){_mm_cvtsi64_si128( a )} )
#define _cvt_v2i32_u64( a ) ( ( uint64_t )_mm_cvtsi128_si64( ( a ).v1 ) )
#define _cvt_v2i64_v2i32( a ) ( ( v2i32_t ){_mm_shuffle_epi32( ( a ).v1, 0xd8 )} )
#define _cvth_v2i64_v2i32( a ) ( ( v2i32_t ){_mm_shuffle_epi32( ( a ).v1, 0x8d )} )

/* transpose */
#define _lo_v2i32( a, b ) ( ( v2i32_t ){_mm_unpacklo_epi32( ( a ).v1, ( b ).v1 )} )
#define _hi_v2i32( a, b )                                                                          \
    ( ( v2i32_t ){_mm_shuffle_epi32( _mm_unpacklo_epi32( ( a ).v1, ( b ).v1 ), 0x0e )} )
