...
def insert_paired_reads(parameter_set, dataset_name, sequencer_name, filename_vec1, filename_vec2):
...
def insert_reads(parameter_set, dataset_name, sequencer_name, filename_vec1):
