  ...
  public:
    ...
    void doAlign( std::function<void( double dPercentageProgress )> fProgressCallBack = []( double ) {} )
    {
        ...
        if( xParameterSetManager.getSelected( )->usesPairedReads( ) )
        {
            ...
            pxPairedWriter.reset( new PairedFileWriter( sSAMFileName, xGenomeManager.getPackPledge( )->get( ) ) );
            ...
            aGraphSinks = setUpCompGraphPaired( xGenomeManager.getPackPledge( ), // Pack
        ...
        else
        {
            ...
            pxWriter.reset( new FileWriter( sSAMFileName, xGenomeManager.getPackPledge( )->get( ) ) );
            ...
            aGraphSinks = setUpCompGraph( xGenomeManager.getPackPledge( ), // Pack
                                          xGenomeManager.getFMDIndexPledge( ), // FMD index
