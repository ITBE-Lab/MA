...
template <class SCORE_TP> class SmithWatermanParamaterSet
{
  ...
  public:
    ...
    SmithWatermanParamaterSet( SCORE_TP xWeightMatch, SCORE_TP xWeightMismatch, SCORE_TP xGapo,
                               SCORE_TP xGape, uint8_t uiAlphabetSize )
    ...
    std::string getTextualDescription( )
    {
        ...
        sDescripton.append( std::to_string( iWeightMatch ) )
            .append( "-" )
            .append( std::to_string( iWeightMismatch ) )
            .append( "-" )
            .append( std::to_string( iGapOpen ) )
            .append( "-" )
