...
#define CHUNK_SIZE ( ( ( size_t )BLOCK_SIZE ) * GRID_SIZE * 2048 * 16 ) /* 2048 * 16 ) */
// #define CHUNK_SIZE ( ((size_t)BLOCK_SIZE) * GRID_SIZE * 2048 * 16 ) // must be a multiple of
// BLOCK_SIZE * GRID_SIZE

//// #define QUERY_SIZE ( 1008 ) // ( 1024 + 512 ) // size query 21 * 48 = 1008 / 768
//// #define REFERENCE_SIZE ( ((size_t)BLOCK_SIZE) * GRID_SIZE * 2048 * 16 * 15 )   // 2048 * 8 ) //
/// 2048 * 5 ) // maximum 4096 * 6
#else
/* 64, 128 are good values for GTX 1080i (TILE_WIDTH 16) */
...
//// #define REFERENCE_SIZE ( BLOCK_SIZE * GRID_SIZE * 2048 * 2 * 1 )   // 2048 * 8 ) // 2048 * 5 )
///// maximum 4096 * 6
#endif
#endif
